...
class EventLog(object):
    ...
    def start(self, sign):
        ...
        # Prevent the state ID of the dynamic UI from changing constantly.
        self.from_state = self.device.get_last_known_state()
...
class ManualEvent(InputEvent):
    ...
    def get_event_str(self, state):
        ...
        return "%s(state=%s,time=%s)" % (self.__class__.__name__, state.state_str, self.time)
