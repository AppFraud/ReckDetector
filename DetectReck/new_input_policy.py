...
class UtgRecketSearchPolicy(UtgBasedInputPolicy):
    ...
    def generate_event_based_on_utg(self):
        ...
        # First search for red packet, confirmation and close tags in the current state
        ...
        # 1 If the current state contains a red packet, restart the app
        if len(specific_events) == 1 and specific_events[0] == 'red_packet':
